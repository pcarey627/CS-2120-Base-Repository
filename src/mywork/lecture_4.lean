...
-/
/-
Introduction rule for equality (How we can build a proof 
of an equality)
-/
...
/-
This is an example of an introduction rule.
...
-/
/-
Elimination rule for equality. (How we can use a proof of
an equality.)
-/
axiom eq_subst : 
...
/-
CONJECTURES: a proposition which you believe is true but don't yet have a 
proof of
-/
...
An introduction rule creates a proof.  Elimination rules use proofs as 
